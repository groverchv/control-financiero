...
('b512f045-76c7-402f-88d5-c9be930fd8a5', 'Carlos', 'Ríos', 'Pérez', 'secretario@control.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '75011831', 'Diseñador Gráfico', 'secretario', 'activo', CURRENT_DATE - interval '16 months'),
('c244f37b-567b-49e6-b224-ae37a75298f2', 'Paula', 'Pérez', 'Pérez', 'paula.perez@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '77980722', 'Ingeniera de Sistemas', 'socio', 'activo', CURRENT_DATE - interval '14 months'),
('d9dd246a-e56e-42a8-8b8b-5b98aafd1303', 'Luis', 'López', 'Vargas', 'luis.lopez@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '75716447', 'Arquitecto', 'socio', 'activo', CURRENT_DATE - interval '12 months'),
('840c927d-7573-451a-9e59-22a3647f8359', 'Sofía', 'Torres', 'Gómez', 'sofia.torres@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '74295931', 'Diseñadora de Modas', 'socio', 'activo', CURRENT_DATE - interval '11 months'),
('15589848-8ffd-4b8d-997d-b03634e02216', 'Miguel', 'Torres', 'Gómez', 'miguel.torres@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '73252383', 'Desarrollador Web', 'socio', 'activo', CURRENT_DATE - interval '10 months'),
('04c47319-1ca6-4b3e-ae97-9c46cf3189f3', 'Roberto', 'Suárez', 'Martínez', 'roberto.suarez@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '76709223', 'Administrador de Empresas', 'socio', 'activo', CURRENT_DATE - interval '9 months'),
('85a6da30-e6a3-4066-91fa-1c63d4dd31b5', 'Andrés', 'Cruz', 'Fernández', 'andres.cruz@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '71959754', 'Administrador Financiero', 'socio', 'activo', CURRENT_DATE - interval '9 months'),
('ed0fb4c3-6435-4d55-9654-85d5b1bdbd60', 'Esteban', 'García', 'Díaz', 'esteban.garcia@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '78491197', 'Contador Público', 'socio', 'activo', CURRENT_DATE - interval '8 months'),
('d965a71e-b7f4-428a-bff2-2c025c0201b2', 'Pedro', 'Cruz', 'García', 'pedro.cruz@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '78107909', 'Ingeniero Civil', 'socio', 'activo', CURRENT_DATE - interval '8 months'),
('dd42db92-1040-4591-8412-592b6c27fb1d', 'Alejandra', 'Pérez', 'Torres', 'alejandra.perez@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '71762776', 'Abogada Corporativa', 'socio', 'activo', CURRENT_DATE - interval '7 months'),
('53dbd038-125d-484b-bd0c-1b51980918fd', 'Lucía', 'Morales', 'Torres', 'lucia.morales@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '75931894', 'Abogada Penalista', 'socio', 'activo', CURRENT_DATE - interval '6 months'),
('3c503b27-de88-4f81-a759-192e801859da', 'María', 'Castillo', 'Romero', 'maria.castillo@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '71113600', 'Administradora Pública', 'socio', 'activo', CURRENT_DATE - interval '6 months'),
('c9d9df36-c6a5-4ef8-bb6d-8a1855caccb9', 'Luisa', 'Sánchez', 'Rodríguez', 'luisa.sanchez@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '73030863', 'Diseñadora Industrial', 'socio', 'activo', CURRENT_DATE - interval '5 months'),
('579e5132-a2c8-4d77-b4b8-9e5e3a7e58ab', 'Jorge', 'Cruz', 'Vargas', 'jorge.cruz@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '76066155', 'Abogado Laboral', 'socio', 'activo', CURRENT_DATE - interval '4 months'),
('7763b5ce-36ef-49a5-8452-54bdfd43aa93', 'Patricia', 'Martínez', 'Cruz', 'patricia.martinez@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '78261633', 'Diseñadora Web', 'socio', 'activo', CURRENT_DATE - interval '3 months'),
('ea4b181e-bfff-4030-809b-e8bed9765ae7', 'José', 'López', 'Ríos', 'jose.lopez@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '78091702', 'Desarrollador Fullstack', 'socio', 'activo', CURRENT_DATE - interval '2 months'),
-- Nuevos miembros para pruebas masivas y paginación
('e0000001-eeee-4444-8888-999999999901', 'Mauricio', 'Paz', 'Ortiz', 'mauricio.paz@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '76290011', 'Ingeniero Mecánico', 'socio', 'activo', CURRENT_DATE - interval '5 months'),
('e0000002-eeee-4444-8888-999999999902', 'Daniela', 'Rojas', 'Soliz', 'daniela.rojas@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '72098711', 'Bioquímica', 'socio', 'activo', CURRENT_DATE - interval '5 months'),
('e0000003-eeee-4444-8888-999999999903', 'Fernando', 'Vargas', 'Mendoza', 'fernando.vargas@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '73012345', 'Economista', 'socio', 'activo', CURRENT_DATE - interval '4 months'),
('e0000004-eeee-4444-8888-999999999904', 'Camila', 'Flores', 'Duarte', 'camila.flores@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '74561234', 'Auditora Financiera', 'socio', 'activo', CURRENT_DATE - interval '4 months'),
('e0000005-eeee-4444-8888-999999999905', 'Ricardo', 'Alba', 'Guzmán', 'ricardo.alba@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '75982121', 'Ingeniero Industrial', 'socio', 'activo', CURRENT_DATE - interval '4 months'),
('e0000006-eeee-4444-8888-999999999906', 'Natalia', 'Camacho', 'Villarroel', 'natalia.camacho@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '71239845', 'Comunicadora Social', 'socio', 'activo', CURRENT_DATE - interval '3 months'),
('e0000007-eeee-4444-8888-999999999907', 'Gabriel', 'Mendez', 'Chávez', 'gabriel.mendez@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '78963214', 'Profesor de Matemáticas', 'socio', 'activo', CURRENT_DATE - interval '3 months'),
('e0000008-eeee-4444-8888-999999999908', 'Valeria', 'Salazar', 'Prado', 'valeria.salazar@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '70215487', 'Psicóloga Clínica', 'socio', 'activo', CURRENT_DATE - interval '3 months'),
('e0000009-eeee-4444-8888-999999999909', 'Hugo', 'Pinto', 'Miranda', 'hugo.pinto@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '77412589', 'Consultor TI', 'socio', 'activo', CURRENT_DATE - interval '2 months'),
('e0000010-eeee-4444-8888-999999999910', 'Elena', 'Guerrero', 'Siles', 'elena.guerrero@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '70548962', 'Odontóloga', 'socio', 'activo', CURRENT_DATE - interval '2 months'),
('e0000011-eeee-4444-8888-999999999911', 'René', 'Zeballos', 'Suárez', 'rene.zeballos@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '73021456', 'Arquitecto de Interiores', 'socio', 'activo', CURRENT_DATE - interval '2 months'),
('e0000012-eeee-4444-8888-999999999912', 'Gisela', 'Heredia', 'Rivas', 'gisela.heredia@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '76985214', 'Periodista', 'socio', 'activo', CURRENT_DATE - interval '1 month'),
('e0000013-eeee-4444-8888-999999999913', 'Claudio', 'Nallar', 'Montaño', 'claudio.nallar@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '78512369', 'Ingeniero de Telecomunicaciones', 'socio', 'activo', CURRENT_DATE - interval '1 month'),
('e0000014-eeee-4444-8888-999999999914', 'Beatriz', 'Maldonado', 'Luna', 'beatriz.maldonado@institucion.com', 'U2FsdGVkX19i8Sgd3k3mLJIjMgc/jlY+uHi42CDPFMI=', '74125896', 'Nutricionista', 'socio', 'activo', CURRENT_DATE - interval '1 month'),
...
('10000001-aaaa-bbbb-cccc-dddddddddd01', '840c927d-7573-451a-9e59-22a3647f8359', 'e58b9198-0dca-4eda-8f45-bed1e5cf1ede', 'confirmado'),
('10000002-aaaa-bbbb-cccc-dddddddddd02', '15589848-8ffd-4b8d-997d-b03634e02216', 'e58b9198-0dca-4eda-8f45-bed1e5cf1ede', 'confirmado'),
('10000003-aaaa-bbbb-cccc-dddddddddd03', '04c47319-1ca6-4b3e-ae97-9c46cf3189f3', 'e58b9198-0dca-4eda-8f45-bed1e5cf1ede', 'confirmado'),
('10000004-aaaa-bbbb-cccc-dddddddddd04', '85a6da30-e6a3-4066-91fa-1c63d4dd31b5', 'e58b9198-0dca-4eda-8f45-bed1e5cf1ede', 'confirmado'),
('10000005-aaaa-bbbb-cccc-dddddddddd05', 'e0000001-eeee-4444-8888-999999999901', 'e58b9198-0dca-4eda-8f45-bed1e5cf1ede', 'confirmado'),
('10000006-aaaa-bbbb-cccc-dddddddddd06', 'e0000002-eeee-4444-8888-999999999902', 'e58b9198-0dca-4eda-8f45-bed1e5cf1ede', 'confirmado'),
('10000007-aaaa-bbbb-cccc-dddddddddd07', 'e0000003-eeee-4444-8888-999999999903', 'e58b9198-0dca-4eda-8f45-bed1e5cf1ede', 'confirmado'),
('10000008-aaaa-bbbb-cccc-dddddddddd08', 'e0000004-eeee-4444-8888-999999999904', 'e58b9198-0dca-4eda-8f45-bed1e5cf1ede', 'confirmado'),
('10000009-aaaa-bbbb-cccc-dddddddddd09', 'e0000005-eeee-4444-8888-999999999905', 'e58b9198-0dca-4eda-8f45-bed1e5cf1ede', 'confirmado'),
('10000010-aaaa-bbbb-cccc-dddddddddd10', 'e0000006-eeee-4444-8888-999999999906', 'e58b9198-0dca-4eda-8f45-bed1e5cf1ede', 'confirmado'),
...
('10000020-aaaa-bbbb-cccc-dddddddddd20', 'c244f37b-567b-49e6-b224-ae37a75298f2', 'd0000001-dddd-1111-2222-333333333301', 'confirmado'),
('10000021-aaaa-bbbb-cccc-dddddddddd21', 'd9dd246a-e56e-42a8-8b8b-5b98aafd1303', 'd0000001-dddd-1111-2222-333333333301', 'confirmado'),
('10000022-aaaa-bbbb-cccc-dddddddddd22', '840c927d-7573-451a-9e59-22a3647f8359', 'd0000001-dddd-1111-2222-333333333301', 'confirmado'),
('10000023-aaaa-bbbb-cccc-dddddddddd23', 'e0000008-eeee-4444-8888-999999999908', 'd0000001-dddd-1111-2222-333333333301', 'confirmado'),
('10000024-aaaa-bbbb-cccc-dddddddddd24', 'e0000009-eeee-4444-8888-999999999909', 'd0000001-dddd-1111-2222-333333333301', 'confirmado'),
('10000025-aaaa-bbbb-cccc-dddddddddd25', 'e0000010-eeee-4444-8888-999999999910', 'd0000001-dddd-1111-2222-333333333301', 'confirmado'),

-- Actividad 2 (d0000002-dddd-1111-2222-333333333302)
('10000030-aaaa-bbbb-cccc-dddddddddd30', '15589848-8ffd-4b8d-997d-b03634e02216', 'd0000002-dddd-1111-2222-333333333302', 'confirmado'),
('10000031-aaaa-bbbb-cccc-dddddddddd31', '04c47319-1ca6-4b3e-ae97-9c46cf3189f3', 'd0000002-dddd-1111-2222-333333333302', 'confirmado'),
('10000032-aaaa-bbbb-cccc-dddddddddd32', '85a6da30-e6a3-4066-91fa-1c63d4dd31b5', 'd0000002-dddd-1111-2222-333333333302', 'confirmado'),
('10000033-aaaa-bbbb-cccc-dddddddddd33', 'e0000011-eeee-4444-8888-999999999911', 'd0000002-dddd-1111-2222-333333333302', 'confirmado'),
('10000034-aaaa-bbbb-cccc-dddddddddd34', 'e0000012-eeee-4444-8888-999999999912', 'd0000002-dddd-1111-2222-333333333302', 'confirmado'),
('10000035-aaaa-bbbb-cccc-dddddddddd35', 'e0000013-eeee-4444-8888-999999999913', 'd0000002-dddd-1111-2222-333333333302', 'confirmado')
ON CONFLICT (id) DO NOTHING;
